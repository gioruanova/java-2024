...
public class App {
    ...
    // throws ExcepcionNacionalidad, ExcepcionEdad {
    // try {
    ...
    private static void registrarBuceadorAdvanced(CentroDeBuceo cba, String string, Object object, int i, int j) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'registrarBuceadorAdvanced'");
    }

    private static void registrarBuceadorTecnico(CentroDeBuceo cba, String string, Object object, int i, int j) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'registrarBuceadorAdvanced'");
    }
    ...
    private static void registrarBuceadorOpenWater(CentroDeBuceo cba, String nombre, String nacionalidad,
        ...
        try {
            // cba.re(new OpenWater(nombre, nacionalidad, edad), idBuceo);
        } catch (Exception e) {
